...
import {
  LayoutDashboard, ShieldCheck, ClipboardList, ShieldAlert, AlertTriangle,
...
const allNavItems = [
  ...
  { label: 'Incidents',   icon: AlertTriangle,   path: '/incidents', roles: ['system_admin', 'security_manager', 'security_supervisor'] },
